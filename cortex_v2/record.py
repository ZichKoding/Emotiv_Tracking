...
def main():
    ...
    r.record_title = 'Test Python Recording' # required param and can not be empty
    r.record_description = 'Trying retrieve data from the cortex api....' # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = './data' # your place to export, you should have write permission, example on desktop
