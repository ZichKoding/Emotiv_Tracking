...
class Train():
    ...
    def get_training_threshold(self):
        self.c.get_mental_command_training_threshold(self.profile_name)
...
def main():
    ...
    profile_name = 'zichko' # set your profile name. If the profile is not exited it will be created.
